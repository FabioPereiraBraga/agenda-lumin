...
<div class="col-lg-6">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="nome" class="form-control" value="{{ $pessoa->nome}}" id="nome" name="nome" placeholder="Nome">
    </div>
  </div>
  <div class="form-group">
    <label for="Apelido" class="col-sm-2 control-label">Apelido</label>
    <div class="col-sm-10">
        <input type="apelido" class="form-control" value="{{ $pessoa->apelido}}" id="apelido"name="apelido" placeholder="apelido">
    </div>
  </div>
  <div class="form-group">
